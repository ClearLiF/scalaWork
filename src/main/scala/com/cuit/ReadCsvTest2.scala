...
object ReadCsvTest2 {
  ...
  def getMovieInfo(movieName: String):String = {
    val spark = SparkSession
      .builder()
      .config("spark.jars","hdfs://master:9000/spark/scalaWork-1.0-SNAPSHOT.jar")
      .master("spark://iZ2zef9frm1cls40k9ekbxZ:7077")
     ...
     .config("spark.sql.codegen.wholeStage", false)
      ...
      .config("spark.driver.host","iZ2zef9frm1cls40k9ekbxZ") //指定driver 的hosts-name
     // .config("spark.driver.extraClassPath","/root/scalaWork-1.0-SNAPSHOT.jar")
      .config("spark.driver.port","9893")//指定driver的服务端口
      .getOrCreate
